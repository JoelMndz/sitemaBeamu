...
class RecibirPaquete extends StatefulWidget {
  const RecibirPaquete({ Key? key }) : super(key: key);

  @override
  _RecibirPaqueteState createState() => _RecibirPaqueteState();
}

class _RecibirPaqueteState extends State<RecibirPaquete> {
  @override
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              crearFila(context, 'Código: ', bodegueroProvider.envio!.id),
              ...
              SizedBox(height: responsive.heightPercentage(1)),
              crearFila(context, 'Tipo: ', bodegueroProvider.envio!.tipo,),
              SizedBox(height: responsive.heightPercentage(1)),
              ...
              SizedBox(height: responsive.heightPercentage(1)),
              crearFila(context, 'Entrar a domicilio: ', bodegueroProvider.envio!.entregaDomicilio ? 'Si' : 'No',),
              SizedBox(height: responsive.heightPercentage(1)),
              ...
              Container(
                ...
                child: ElevatedButton(
                  onPressed: bodegueroProvider.cargando ? null : ()=> bodegueroProvider.recibirPaquete(context), 
                  child: bodegueroProvider.cargando ? 
                    CircularProgressIndicator(
                      color: Theme.of(context).colorScheme.onPrimary,
                    ) : 
                    Text('Recibir paquete',style: TextStyle(fontSize: 20),)
                ),
              ),
              SizedBox(height: responsive.heightPercentage(1)),
            ],
